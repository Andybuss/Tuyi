...
public class RegisterActivity extends BaseActivity {
    ...
    public void register(View view) {
        ...
        if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(pwd)) {
            ...
            final Dialog dialog = new android.app.AlertDialog.Builder(RegisterActivity.this).create();
            dialog.setCancelable(true);
            dialog.show();
            dialog.getWindow().setContentView(R.layout.wait_dialog);
            TextView msg = (TextView) dialog.findViewById(R.id.wait_text);
            msg.setText("正在注册中...");
            dialog.show();
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                saveUser2Bmob(userNameEditText.getText().toString(),pwd);
                            }
                        });
    ...
    private void saveUser2Bmob(final String username, final String p)
    {
